package sulamerica.atendimentoLaboratorio.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("sulamerica.atendimentoLaboratorio.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Atendimento Laboratório").description("Projeto API Spring - Atendimento Laboratório")
